...
int main() {
    ...
    std::uniform_int_distribution<int> randomInfoFromVector(0, 9);
    ...
    const std::vector<unsigned int> distance = {60, 100, 200, 300, 400, 800, 1500, 3000, 5000, 10000};

    // Creating competitions
    std::vector<Competition*> competitions = {new Competition("Athletic Diamond League, Qualifications", DateTime("09/06/2020 09:00:00"), DateTime("16/06/2020 19:10:00")),
                                              new Competition("Athletic Diamond League, Half Finals", DateTime("13/06/2020 10:30:00"), DateTime("20/06/2020 20:00:00")),
                                              new Competition("Athletic Diamond League, Grand Finale", DateTime("18/06/2020 12:15:00"), DateTime("25/06/2020 20:00:00"))};
